...
var graphics = (function() {
	...
	function mouseClick(event) {
		if( isLineHighlighted) {
			...
			ga('send', 'event', 'Dots And Boxes', 'Play');
	...
	function showSettings() {
		...
		if( form.style.display === "block" ) {
			...
			ga('send', 'event', 'Dots And Boxes', 'Show Settings', 'show');
		}
		else {
			form.style.display = "block";
			this.style["border-color"] = "black";
			ga('send', 'event', 'Dots And Boxes', 'Show Settings', 'hide');
	...
	function newGameButtonPressed() {
		ga('send', 'event', 'Dots And Boxes', 'New Game');
